...
export const AutoStartSetting: React.FC = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div>
                <h1 data-testid="startupSettingsHeader" className="font-bold">
                    {t('behavior.autoStart.title')}
                </h1>
                <p data-testid="startupSettingsSubHeader" className="text-sm">
                    {t('behavior.autoStart.description')}
                </p>
            </div>
            <div className="flex flex-col shrink items-start justify-center gap-0 ">
                {platform === 'linux' ? (
                    <span className="alert alert-warning flex flex-row gap-2 items-center">

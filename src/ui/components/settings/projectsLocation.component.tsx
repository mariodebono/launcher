        ...
        <>
            {
                ...
                <div className="absolute inset-0 z-10 w-full h-full bg-black/80 flex flex-col items-center justify-center">
                    <p className="loading loading-infinity"></p><p>{t('behavior.projectsLocation.waitingForDialog')}</p>
                </div>
            }
            <div className="flex flex-col gap-4 ">

                <div className="flex flex-col">
                    <h1 data-testid="projectLocationHeader" className="font-bold">{t('behavior.projectsLocation.title')}</h1>
                    <p data-testid="projectLocationSubHeader" className="text-sm">{t('behavior.projectsLocation.description')}</p>
                </div>
                <button
                ...
                >
                    <div className="flex flex-col flex-1 items-start">
                        <div className="flex flex-row  items-center gap-2 text-sm text-base-content/50">
                            ...
                            {t('behavior.projectsLocation.defaultLocation')}</div>

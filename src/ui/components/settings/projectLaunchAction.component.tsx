...
export const ProjectLaunchAction: React.FC = () => {
    ...
    return (
        <div className="flex flex-col gap-4">
            <div>
                <h1 data-testid="projectLaunchSettingsHeader" className="font-bold">{t('behavior.projectLaunch.title')}</h1>
                <p data-testid="projectLaunchSettingsSubHeader" className="text-sm">{t('behavior.projectLaunch.description')}</p>
            </div>

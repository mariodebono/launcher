            ...
            <div>
                <div className="flex flex-col flex-shrink items-start  gap-0 ">
                    <label className="label flex flex-row gap-4">
                        <input onChange={onAutoStartChanged} data-testid="chkAutoStartCheckbox" type="checkbox" checked={preferences?.auto_start} className="checkbox" />
                    ...
                    <label className={clsx('label flex flex-row gap-4 pl-12', { 'cursor-not-allowed': (preferences?.auto_start === false) })} aria-disabled={preferences?.auto_start === false}>
                        <input onChange={setStartInTray} data-testid="chkStartInTrayCheckbox" type="checkbox" checked={preferences?.start_in_tray} className="checkbox" disabled={preferences?.auto_start === false} />
                        Start in tray.
                    </label>
                </div>
            </div>

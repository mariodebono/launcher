            ...
            <div className="flex flex-col h-full w-full p-1">
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <h1 data-testid="helpTitle" className="text-2xl">{t('title')}</h1>
                            ...
                            <div className='flex flex-col h-0 gap-4'>
                                ...
                                <div className="flex flex-row gap-0">
                                    <div className="flex flex-col flex-1 gap-2">
                                        <h1 className="flex gap-1 items-baseline text-xl">{t('launcher.title')}
                                            <button
                                                onClick={() => openChangeLog()}
                                                className="btn-link flex-row items-center text-sm m-0 p-0 flex gap-1">{t('launcher.changelog')}<ExternalLink className="h-4 w-4 m-0 p-0" />
                                            </button>
                                        </h1>
                                        <ul className="flex flex-col gap-0">
                                            <li>
                                                <h3 className="font-bold">{t('launcher.homePage')}</h3>
                                            ...
                                            <li>
                                                <h3 className="font-bold">{t('launcher.docs')}</h3>
                                    ...
                                    <div className="flex flex-col flex-1 gap-2">
                                        ...
                                        <h1 className="text-xl">{t('godot.title')}</h1>
                                        <ul className="flex flex-col gap-0">
                                            <li>
                                                <h3 className="font-bold">{t('godot.engine')}</h3>
                                            ...
                                            <li>
                                                <h3 className="font-bold">{t('godot.docs')}</h3>
                                ...
                                <div className="flex flex-1">
                                    <div className="flex flex-col flex-1 gap-2">
                                        <h1 className="text-xl flex flex-row items-baseline gap-1">{t('community.title')}
                                            <button
                                                onClick={() => openExternalLink(COMMUNITY_PAGE_URL)}
                                                className="btn-link flex-row items-center text-sm m-0 p-0 flex gap-1">{t('community.learnMore')}<ExternalLink className="h-4 w-4 m-0 p-0" />
                                            </button>
                                        </h1>
                                ...
                                <div className="flex flex-1">
                                    <div className="flex flex-col flex-1 gap-2">
                                        ...
                                        >{t('contribute.title')} <button
                                                onClick={() => openExternalLink(LAUNCHER_CONTRIBUTE_URL)}
                                                className="btn-link flex-row items-center text-sm m-0 p-0 flex gap-1">{t('contribute.learnMore')}<ExternalLink className="h-4 w-4 m-0 p-0" />
                                            </button>
                                        </h1>
                                        <p>{t('contribute.description')}</p>
                                        <ul className="flex gap-2">
                                            <li>
                                                <button onClick={() => openExternalLink(LAUNCHER_GITHUB_ISSUES_URL)} className="btn btn-link gap-1">{t('contribute.reportBug')}<ExternalLink className="h-4 w-4 m-0 p-0" /></button>
                                            </li>
                                            <li>
                                                <button onClick={() => openExternalLink(LAUNCHER_GITHUB_PROPOSALS_URL)} className="btn btn-link gap-1">{t('contribute.suggestion')}<ExternalLink className="h-4 w-4 m-0 p-0" /></button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
